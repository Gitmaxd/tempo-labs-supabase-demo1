...
export default async function Navbar() {
  ...
  return (
    <nav className="w-full border-b border-gray-200 dark:border-zinc-900/50 bg-white/80 dark:bg-black/80 py-2 sm:py-3 sticky top-0 z-30 backdrop-blur-sm dark:backdrop-blur-md transition-theme dark:glass-effect">
