...
export default function Hero() {
  return (
    <div className="relative overflow-hidden bg-white dark:bg-black transition-theme min-h-[calc(100vh-73px)] flex flex-col justify-center">
      ...
      <div className="relative py-8 md:py-12 flex-grow flex items-center">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight relative">
              Tempo Labs{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <div className="animated-border group">
                <Link
                  href="/sign-up"
                  className="inline-flex items-center px-6 py-3 text-white bg-blue-600 hover:bg-blue-700 dark:bg-black dark:hover:bg-zinc-900 rounded-lg transition-colors text-base md:text-lg font-medium relative overflow-hidden"
                >
              ...
              <Link
                href="/sign-in"
                className="inline-flex items-center px-6 py-3 text-gray-700 dark:text-white bg-gray-100 dark:bg-zinc-900/80 hover:dark:bg-zinc-800 rounded-lg hover:bg-gray-200 transition-colors text-base md:text-lg font-medium dark:backdrop-blur-sm"
              >
                Sign In
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 items-start max-w-6xl mx-auto">
            <div className="lg:col-span-2 lg:pr-6">
              <div className="sticky top-24">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm md:text-base">
                  Our intuitive role management system gives you complete control over user permissions and access levels.
                </p>
                <ul className="space-y-2 mb-6 text-sm md:text-base">
                  <li className="flex items-start dark:text-white">
                    <CheckCircle2 className="w-4 h-4 text-green-500 dark:text-blue-400 mr-2 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <div className="flex items-center gap-2 dark:bg-gradient-dark-gray px-3 py-1 rounded-full dark:backdrop-blur-sm text-xs md:text-sm">
                    <UserCircle className="w-4 h-4 text-blue-500 dark:text-gray-300" />
                    <span className="text-gray-600 dark:text-gray-400">Three user roles</span>
                  </div>
                  <div className="flex items-center gap-2 dark:bg-gradient-gray-light px-3 py-1 rounded-full dark:backdrop-blur-sm text-xs md:text-sm">
                    <ShieldCheck className="w-4 h-4 text-blue-500 dark:text-gray-300" />
                    <span className="text-gray-600 dark:text-gray-400">Secure access</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="lg:col-span-3 static-border rounded-xl premium-shadow max-w-lg mx-auto md:max-w-none w-full">
              <div className="bg-white dark:bg-zinc-900/80 p-3 rounded-xl overflow-hidden">
                {/* Role Management UI Mockup */}
                <div className="rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-zinc-800 transform scale-[0.85] origin-top">
                  {/* Header */}
                  <div className="bg-white dark:bg-black p-3 border-b border-gray-200 dark:border-zinc-800 flex items-center justify-between">
                    ...
                    <button className="px-2 py-0.5 bg-blue-600 text-white text-xs rounded-md flex items-center gap-1">
                  ...
                  <div className="bg-gray-50 dark:bg-zinc-900">
                    ...
                    <div className="p-3 border-b border-gray-200 dark:border-zinc-800">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Manage the roles available in the system</p>
                      
                      {/* Roles Table */}
                      <div className="bg-white dark:bg-black rounded-md overflow-hidden border border-gray-200 dark:border-zinc-800">
                        {/* Table Header */}
                        <div className="grid grid-cols-4 text-xs font-medium text-gray-500 dark:text-gray-400 p-2 border-b border-gray-200 dark:border-zinc-800">
                          <div>ID</div>
                          <div>Role</div>
                          <div>Description</div>
                          <div>Actions</div>
                        ...
                        {/* Admin Role */}
                        <div className="grid grid-cols-4 text-xs p-2 border-b border-gray-200 dark:border-zinc-800 items-center">
                          ...
                          <div>
                            <button className="px-2 py-0.5 bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 text-xs rounded">Edit</button>
                          </div>
                        </div>
                        ...
                        {/* User Role */}
                        <div className="grid grid-cols-4 text-xs p-2 items-center">
                    ...
                    <div className="p-3">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Configure what each role can access in the system</p>
